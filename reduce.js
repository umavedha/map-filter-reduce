...
console.log('10. Total cost of all the objects with that category',list)
console.log('------------------------------------------');



// find minimum price using reduce
let prices=[{id:1,productName:'Table',price:3260},
                      {id:2,productName:'Chair',price:1060},
                      {id:3,productName:'Sofa',price:4800},
                      {id:4,productName:'TV Unit',price:8078},
                      {id:5,productName:'Wardrobe',price:13260},
 ...
 let minimumPrice=  prices.reduce((a,b)=>{
    ...
    // let min = prices.reduce((e,a)=>{

    // console.log(e.price,'........',a.price);
        
    //  return e=e.price<a.price ? e.price:a.price;
